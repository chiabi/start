## Susy
 - 참고사이트
 	- [susydocs (doc)](http://susydocs.oddbird.net/en/latest/)
 	- [susy settings (kor.doc)](http://webclub.tistory.com/246)
 	- [susy tutorial (video)](https://leveluptutorials.com/tutorials/susy-tutorials)

### Susy Global Settings gist
- 기본 글로벌 설정 : $susy(susy전역 변수)에 설정할 수 있다.
```scss
/*
 * Susy Globa Settings
